...
class PanelFilterImpl implements PanelFilter {
    ...
    @AssistedInject
    public PanelFilterImpl(FilterModel model, FilterDialogFactory dialogFactory, @Assisted FilterFromDialog filter) {
        this.model = model;
    ...
    @AssistedFactory
    interface Factory {
        PanelFilterImpl create(FilterFromDialog filter);
    }
}
