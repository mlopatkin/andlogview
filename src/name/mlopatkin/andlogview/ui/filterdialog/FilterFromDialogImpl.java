...
public class FilterFromDialogImpl implements FilterFromDialog, ColoringFilter {
    ...
    FilterFromDialogImpl(boolean enabled, FilterFromDialogData data) {
    ...
    public FilterFromDialogImpl enabled() {
        return enabled ? this : new FilterFromDialogImpl(true, data);
    }

    @Override
    public FilterFromDialogImpl disabled() {
        return enabled ? new FilterFromDialogImpl(false, data) : this;
    }
