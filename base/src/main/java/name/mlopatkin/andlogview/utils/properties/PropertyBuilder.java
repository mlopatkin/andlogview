...
public class PropertyBuilder<T extends @Nullable Object> implements IPropertyBuilder<T> {
    ...
    static <T extends @Nullable Object> PropertyBuilder<T> newPropertyBuilder(Class<T> type) {
